import { d as reactExports, j as jsxRuntimeExports, a6 as Info, a2 as CircleX, B as CircleCheck, e as cn, a3 as LoaderCircle, aA as CircleAlert, aB as RefreshCw, aC as reactDomExports, ab as X, aD as changePassword, aE as sessionsApi, aF as Monitor } from "./index-DS595Jt3.js";
"use client";
...
function MotionConfig({ children, isValidProp, ...config2 }) {
  ...
  config2 = { ...reactExports.useContext(MotionConfigContext), ...config2 };
...
class NativeAnimationControls {
  ...
  get time() {
    var _a;
    if (this.animation) {
      return /* @__PURE__ */ millisecondsToSeconds(((_a = this.animation) === null || _a === void 0 ? void 0 : _a.currentTime) || 0);
    }
    return 0;
  }
  set time(newTime) {
...
function applyGeneratorOptions(options) {
  ...
  if (isGenerator(options.type)) {
    ...
    options.duration = /* @__PURE__ */ secondsToMilliseconds((_a = options.duration) !== null && _a !== void 0 ? _a : 0.3);
...
function convertMotionOptionsToNative(valueName, keyframes2, options) {
  ...
  nativeOptions.delay = /* @__PURE__ */ secondsToMilliseconds((_a = options.delay) !== null && _a !== void 0 ? _a : 0);
    ...
    transition.ready.then(() => {
      ...
      for (const animation of generatedViewAnimations) {
        ...
        if (!targetDefinition) {
          ...
          effect.updateTiming({
            delay: /* @__PURE__ */ secondsToMilliseconds((_a = animationTransition.delay) !== null && _a !== void 0 ? _a : 0),
...
const config = {
  success: {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-emerald-500" }),
    className: "border-emerald-200"
  },
  error: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-4 w-4 text-red-500" }), className: "border-red-200" },
  info: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "h-4 w-4 text-blue-500" }), className: "border-blue-200" }
};
function ToastProvider({ children }) {
  const [items, setItems] = reactExports.useState([]);
  const toast = reactExports.useCallback((message, type = "info") => {
    const id2 = Date.now() + Math.random();
    setItems((prev) => [...prev, { id: id2, type, message }]);
    setTimeout(() => setItems((prev) => prev.filter((t) => t.id !== id2)), 4200);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ToastContext.Provider, { value: toast, children: [
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed bottom-4 right-4 z-[200] flex w-full max-w-sm flex-col gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: items.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
...
function Spinner({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: cn("h-5 w-5 animate-spin text-gray-400", className) });
}
function LoadingBlock({ label = "Loading…" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-2 py-16 text-gray-400", children: [
...
function StatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("h-1.5 w-1.5 rounded-full", dot[tone]) }),
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-500", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-3xl font-semibold tracking-tight text-gray-900", children: value }),
    sub && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-gray-400", children: sub })
  ] });
}
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-3 py-16 text-center", children: [
    icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-300", children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-900", children: title }),
...
function ErrorState({ message, onRetry }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-3 py-16 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-gray-600", children: message }),
    onRetry && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "secondary", size: "sm", onClick: onRetry, children: [
...
function Dialog({
  ...
  return reactDomExports.createPortal(
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[100] overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-gray-900/40 backdrop-blur-sm", onClick: onClose }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex min-h-full items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between px-6 pt-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-900", children: title }),
                description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-sm text-gray-500", children: description })
              ] }),
            ...
            footer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end gap-2 border-t border-gray-100 px-6 py-4", children: footer })
          ]
        }
      ) })
    ] }),
...
const controlBase = "flex h-10 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 disabled:opacity-50";
const Input = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref, className: cn(controlBase, className), ...props })
);
...
function Select({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: cn(controlBase, "appearance-none pr-8", className), ...props, children });
}
function Field({
  label,
  htmlFor,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor, className: "block text-sm font-medium text-gray-700", children: label }),
    children,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Dialog,
    {
      ...
      footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { loading: saving, onClick: submit, children: "Update password" })
      ] }),
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "New password", hint: "At least 8 characters. Signs you out of other sessions.", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "password",
            value: next,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Confirm new password", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "password",
            value: confirm,
...
function SessionsDialog({ open, onClose }) {
  ...
  const revoke = async (id2) => {
    setBusy(true);
    try {
      await sessionsApi.revoke(id2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Dialog,
    {
      ...
      footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "danger", onClick: revokeOthers, disabled: busy || !hasOthers, children: "Sign out other devices" })
      ] }),
      children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin text-gray-400" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: sessions.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-lg border border-gray-200 px-3 py-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { className: "h-4 w-4 shrink-0 text-gray-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "truncate text-sm font-medium text-gray-800", children: [
            s.userAgent || "Unknown device",
            s.current && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs font-normal text-brand-700", children: "This device" })
          ] }),
